...
public class NameRegexSearchCriteria implements ISearchCriteria {
    private String searchPattern;
    private Pattern searchPatternCompiled;

    public NameRegexSearchCriteria(String searchPattern) {
    ...
    public boolean checkCriteria(SASDetailedObject object) {
        return searchPatternCompiled.matches(object.getName());
    }
}
